...
import 'animate.css';
import BackgroundImage from './assets/imageSixx.svg';
      ...
      <div className="w-screen flex items-center flex-col justify-center p-1 border back">
        ...
        <div className='flex md:hidden flex-row font-Afacad md:justify-between px-[25px] pt-[45px]' style={{
          ...
          <div className='flex flex-col'>
            <h1 className='text-black text-3xl md:text-8xl font-semibold'>
              <span className='text-6xl md:text-9xl'>W</span>eb development <span className='text-slate-600'>Bootcamp</span>
            </h1>
            <p className='text-md md:text-2xl pt-[25px]'>
              Want to build and design websites from scratch? 6lacktech offers interactive courses tailored to beginners and advanced learners alike. Choose your path:
            </p>
          </div>
          <img src={Girl} alt='Lady' className='relative w-48 md:w-96 md:-right-0' />
        </div>

        <div className="bg-container hidden md:flex items-center justify-center w-full p-4" style={{
          backgroundImage: `url(${BackgroundImage})`,
          backgroundRepeat: 'no-repeat',
          backgroundPosition: isMobile ? 'bottom' : 'right',
          backgroundSize: 'contain',
            ...
            <div className="space-y-10">
              ...
              <div className="md:w-[640px] w-[350px] md:space-x-8 tracking-wider leading-6 animate__animated animate__lightSpeedInLeft text-xl">
                <p className='tracking-wider leading-10'>
                  Want to build websites from scratch? 6lacktech offers beginner and advanced courses in frontend, backend, and full-stack development with HTML, CSS, Tailwindcss, JavaScript, React, Python, Django, Node.js, and more.
                </p>
              </div>
            </div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 my-10 relative font-Afacad gap-3 mb-[11px] pt-9 mx-[25px] items-baseline'>
          {[{
            ...
            duration: "6 Weeks",
            price: "GHC 300",
            description: "Build your website from scratch, no prior knowledge needed!",
            link: "https://paystack.com/pay/6lacktech",
          }, {
            title: "HTML, CSS, JavaScript, Design",
            duration: "8 Weeks",
            price: "GHC 500",
            description: "Learn coding plus design with Figma for a professional edge.",
            link: "https://paystack.com/pay/6lacktech1",
          }, {
            title: "HTML, CSS, Js, Design, & React",
            duration: "10 Weeks",
            price: "GHC 800",
            description: "Elevate your skills with React for dynamic websites.",
            link: "https://paystack.com/pay/6lacktech2",
          }].map((course, index) => (
            <div key={index} className='p-3 md:p-6 bg-slate-950 text-white space-y-2 hover:font-bold rounded-md hover:bg-black/50 group' style={{
              ...
              <h1 className='font-medium text-sm md:text-xl'>{course.title}</h1>
              <p className='text-sm md:text-xl'>Duration: {course.duration}</p>
              <h1 className='text-2xl md:text-4xl font-medium'>{course.price}</h1>
              <p className='text-sm md:text-xl'>{course.description}</p>
